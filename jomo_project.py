...
# -*- coding: utf-8 -*-
"""
Created on Thu Oct 24 10:04:24 2024
...
print(f"the average revenue of all movie is {average_revenue:.2f} Million")

movies_2015_2017 = df[(df['Year'] >=2015)&(df['Year']<=2017)]
average_revenue_2015_2017 = movies_2015_2017['Revenue (Millions)'].mean()
print(f"The average revenueof movie from 2015 to 2017 is {average_revenue_2015_2017:2f} Million")
...
high_rating_count = df[df['Rating'] >= 8.0].shape[0]
print(f"The number of movies with a rating of at least 8.0 is: {high_rating_count}")
